...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $contact = $row['C_Mobile_No'];
        $email = $row['C_Email'];
        $AccountType = $row['AccountType'];
        $Status = $row['Status'];
        $Balance = $row['Balance'] + $row['SavingBalance'];
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-1">
                                    ...
                                    <span class="text-muted">Your Total Balance: <?php echo($Balance)?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-1">
                                    <span class="text-danger"> <i class="mdi mdi-arrow-bottom-right"></i></span>
                                    <span class="text-muted">Your Total Saving Balance: <?php echo($SBalance)?> </span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div style="display: flex; justify-content: space-between;">
                                    ...
                                    <div class="text-left">
                                        <p id="AcNo"><?php echo$AccountNo?></p>
                                        <p id="AcType"><?php echo$AccountType?></p>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div style="display: flex; justify-content: space-between;">
                                            ...
                                            <div class="text-left">
                                                <p id="MobileNo"><?php echo ($contact)?></p>
