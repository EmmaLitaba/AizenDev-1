    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="pages/about.php">About</a></li>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  ...
                  <?php echo BANKNAME ?> is the best bank for Monitoring account it provide data in graphical manner from that can we understand our account is in profit or loss. Also i use saving option which is wonderful.
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  The Transaction system of the <?php echo BANKNAME ?> is very fast. We can easily manage our transaction history
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  ...
                  and start your online banking. Thank You <?php echo BANKNAME ?>!
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
          ...
          <ul>
            <li data-aos="fade-up" data-aos="fade-up" data-aos-delay="100">
              ...
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <p>
                  You just need to follow 3 steps to start banking with us. Lets introduce to you with account creation steps. <br>

                  1 Fill Your Basic Detail. <br>
                  2 Validate Your Email Account. <br>
                  3 Create Username and Password. <br>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <h1 class="text-center mt-2"><?php echo BANKNAME ?></h1>
          </div>
