...
if (isset($_POST['AccountNumber'])) {
    ...
    $query = "SELECT * FROM login where AccountNo = '$AccountNo' and Status = 'Inactive'";
...
if (isset($_POST['CloseAc'])){
    $cAcc = $_POST['CloseAc'];
    $query ="DELETE FROM account WHERE `account`.`AccountNo` = $cAcc";
    $res = mysqli_query($conn, $query) or die("Not Execute");
    echo('Success');
