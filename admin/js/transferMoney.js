    ...
    $("#Amount").on({
        ...
        keyup: function () {
            ...
            if (Amount >= 10) {
                ...
                $("#AmountError").text("Please Enter Minimum 10 dollars");
            }
        }
        ...
        if (SenderAc != "") {
            ...
            if (ReceiverAc != "") {
                ...
                if (Amount >= 10) {
                    $("#AmountError").text("");
                    swal({
                        title: "Are you sure to transfer of Amount" + "   " + "$" + Amount +"to" +ReceiverAc ,  
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    }).then((willDelete) => {
                    ...
                    $("#AmountError").text("Please Enter Minimum 10 dolars");
                }
            }
